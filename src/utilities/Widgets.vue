		...
		<div class="p-col-12 p-lg-4">
			<div class="card">
				...
				<ul class="widget-image-list">
					...
					<li>
                            <span>
                                <img src="assets/layout/images/product/bamboo-watch.jpg" alt="Bamboo Watch" />
					...
					<li>
                            <span>
                                <img src="assets/layout/images/product/blue-band.jpg" alt="Blue Band" />
                                <span>Blue Band</span>
                            </span>
					...
					<li>
                            <span>
                                <img src="assets/layout/images/product/game-controller.jpg" alt="Game Controller" />
					...
					<li>
                            <span>
                                <img src="assets/layout/images/product/lime-band.jpg" alt="Lime Band" />
                                <span>Lime Band</span>
                            </span>
				...
				<div class="widget-chat">
					<ul>
						<li class="message-from">
							<img src="assets/layout/images/avatar/ionibowcher.png" alt="ionibowcher" />
							<div>Retro occupy organic, stumptown shabby chic pour-over roof party DIY normcore.</div>
						</li>
						<li class="message-own">
							<img src="assets/layout/images/avatar/onyamalimba.png" alt="onyamalimba" />
				...
				<ul class="widget-person-list">
					<li>
						<div class="person-item">
							<img src="assets/layout/images/avatar/amyelsner.png" alt="amyelsner" />
					...
					<li>
						<div class="person-item">
							<img src="assets/layout/images/avatar/annafali.png" alt="annafali" />
							<div class="person-info">
					...
					<li>
						<div class="person-item">
							<img src="assets/layout/images/avatar/bernardodominic.png" alt="bernardodominic" />
							<div class="person-info">
					...
					<li>
						<div class="person-item">
							<img src="assets/layout/images/avatar/ivanmagalhaes.png" alt="ivanmagalhaes" />
							<div class="person-info">
					...
					<li>
						<div class="person-item">
							<img src="assets/layout/images/avatar/xuxuefeng.png" alt="xuxuefeng" />
							<div class="person-info">
		...
		<div class="p-col-12 p-lg-4">
			<div class="card widget-user-card">
				<div class="user-card-header">
					<img src="assets/layout/images/avatar/profile.jpg" class="user-card-avatar" alt="profile" />
				</div>
